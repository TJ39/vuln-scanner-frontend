...
function MainScanner() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 font-roboto-mono text-gray-300 overflow-x-hidden flex flex-col">
      ...
      {/* Footer */}
      <footer className="text-center text-gray-400 text-sm py-6 border-t border-gray-700 shrink-0">
        <div className="mb-4">
          <Link to="/privacy" className="hover:text-cyan-300 mx-2">
            Privacy Policy
          </Link>
          <Link to="/terms" className="hover:text-cyan-300 mx-2">
            Terms of Service
          </Link>
          <Link to="/contact" className="hover:text-cyan-300 mx-2">
            Contact
          </Link>
        </div>
